...
<header class="header">
    ...
    <form action="/buscar" method="get" class="header__search">
        <input type="search" name="query" class="header__search-input" placeholder="Buscar...">
        <select name="tipo" class="header__search-select">
            <option value="libros">Libros</option>
            <option value="foros">Foros</option>
        </select>
        <button type="submit" class="header__search-button">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="header__search-icon">
                <g>
